...
namespace ContosoUniversity.DAL
{
    ...
    //3lshan low el DB bta3ty w23t mn el classb hna la arg3 a3mlo tany ala2y el daata mawgoda w msh ha7tag aktbyha tany 
    {
        protected override void Seed(SchoolContext context)  //Seed method will run when the database is re-created and will re-create your test data.But in production you generally don't want to lose all your data every time you need to change the database schema 
        {
